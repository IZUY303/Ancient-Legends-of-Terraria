...
namespace CraftMaxedHacks
{
    ...
    {
        public Color CustomCurrencytextcolor = Color.ForestGreen; //this defines the Custom Currency Buy Price color when shown in the shoop
            ...
            lines[currentLine++] = string.Format("[c/{0:X2}{1:X2}{2:X2}:{3} {4} {5}]", new object[]
                {
                    ...
                    Lang.tip[50],
                    price,
                    "Runes" //this is the Currency name when shown in the shop
                });
        }
    }
}