...
{
	public class FireAquaSword : ModItem
	{
		public override void SetDefaults()
		{
			item.name = "Flame-Aqua Thrower";
			item.melee = true;
			item.width = 40;
			item.height = 40;
			item.toolTip = "Hot but liquified";
			item.toolTip2 = "Left Click:Ingnites enemies";
			item.toolTip2 = "Right Click:Throws bunch of bubbles";
			item.toolTip2 = "Hot but liquified";
			item.knockBack = 6;
			item.value = 10000;
			item.rare = 2;
