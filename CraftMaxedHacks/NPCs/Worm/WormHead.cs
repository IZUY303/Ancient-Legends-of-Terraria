...
namespace CraftMaxedHacks.NPCs.Worm
{
    public class WormHead : ModNPC
    {
        public override void SetDefaults()
        {
            npc.name = "The Mecha of Worlds";        //this is the npc Name
            npc.displayName = "The Mecha of Worlds";
            npc.lifeMax = 100000;        //this is the npc health
            npc.damage = 200;    //this is the npc damage
            npc.defense = 120;         //this is the npc defense
        ...
        public override void BossLoot(ref string name, ref int potionType)
        {
			...
			{
				Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("MechaOfWorldTrophy"));	
			}
		}
        ...
        {
            bossHeadTexture = "CraftMaxedHacks/NPCs/Worm/WormHead_map"; //the boss head texture
        }
        ...
        public override bool PreAI()
        {
            if (Main.netMode != 1)
            {
                ...
                if (npc.ai[0] == 0)
                {
                    ...
                    int randomWormLength = Main.rand.Next(148, 158);
