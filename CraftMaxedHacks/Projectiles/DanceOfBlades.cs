...
namespace CraftMaxedHacks.Projectiles
{
	public class DanceOfBlades : ModProjectile
	{
		...
		{
			projectile.name = "Yeyint's Lightsabre";
			projectile.width = 220;
			projectile.height = 220;
			projectile.friendly = true;
			projectile.penetrate = -1; //-1 is infinite
		...
		private void CreateBlade()
		{
			...
			Projectile.NewProjectile(x, y, 0f, 12f, mod.ProjectileType("ForceProj"), projectile.damage, projectile.knockBack, projectile.owner);
		}
